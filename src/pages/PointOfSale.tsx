...
const PointOfSale = () => {
    ...
    const loadInitialState = useCallback(() => {
                ...
                activeTab.appliedOffers.forEach(offerId => {
                    ...
                    if (offer) {
                        ...
                        if (offer.applicableProducts) {
                            const hasApplicableProducts = currentCart.some(item => 
        ...
        }, [activeTab, decryptedBusinessConfig, availableOffers, customerInfo, convertPrice]);
        ...
        const generateBillDetails = useCallback(() => {
            ...
            return billText;
        }, [activeTab, decryptedBusinessConfig, subtotal, tax, discountAmount, total, t, customerInfo, availableOffers, currentCurrency]);
        ...
        const processSale = useCallback(async (customerData: CustomerInfo) => {
            ...
            const saleData: SaleData = {
                ...
                userId: user.uid,
                status: 'completed',
                appliedOffers: activeTab.appliedOffers || [], // Ensure this is never undefined
        ...
        }, [activeTab, subtotal, tax, discountAmount, total, decryptedBusinessConfig, isMobile, t, currentCurrency]);
        ...
        }, [activeTab, availableOffers, customerInfo, updateTabState, t, currentCurrency]);
    ...
    <TabsList className="w-full overflow-x-auto flex flex-nowrap whitespace-nowrap pb-2">
        <TabsTrigger value="all" className="flex-shrink-0 px-5">
            {t('AllProducts')}
        </TabsTrigger>
                ...
                {searchQuery ? t('NoProductsFound') : t('NoProductsInCategory')}
                    ...
                    <div className={`${(isMobile && !showCart) ? "hidden" : ""} space-y-6`}>
                        <Card className="animate-fade-in">
                            <div className="bg-billing-dark text-white p-3 md:p-8 flex justify-between items-center">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        {PAYMENT_METHODS.map(method => (
                                            ...
                                            >
                                                {method.icon || <Wallet className="h-4 w-4" />}
